...
void on_create(HWND hw)
{
	...
	CreateWindow("Button", "One", WS_CHILD | WS_VISIBLE, 25, 25, 120, 40, hw, HMENU(id_button1), NULL, NULL);
	CreateWindow("Button", "Two", WS_CHILD | WS_VISIBLE, 25, 75, 120, 40, hw, HMENU(id_button2), NULL, NULL);
}
